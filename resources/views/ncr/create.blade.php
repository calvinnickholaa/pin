    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                            ...
                            <<<<<<< HEAD <div class="col">
                                <div class="form-group" id="itemm">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-1">
                                            <button onclick="add_item(this)" type="button"
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                value="{{ $jumlah_ncr }}/NCR/AST/{{ Carbon\Carbon::now()->format('m') }}/{{ Carbon\Carbon::now()->year }}"
                                                class="form-control" type="string" id="nomor_ncr" name="nomor_ncr"
                                                readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <<<<<<< HEAD <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Dilaporkan Oleh :</label>
                                            <input value="{{ auth()->user()->name }}" class="form-control"
                                                type="string" id="pelapor" name="pelapor" readonly />
                                        </div>
                                </div>
                ...
                >>>>>>> 7a79e1e0045fa7a73ae813499a516d8225b22fcb
